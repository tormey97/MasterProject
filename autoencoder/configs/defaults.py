...
cfg.MODEL.EVAL_STEP = 30000
cfg.MODEL.AVGPOOL_ENCODING = False
cfg.MODEL.AVG_POOL_COUNT = 1
cfg.MODEL.MODEL_NAME="gan"
cfg.MODEL.QUANTIZE = True
cfg.MODEL.C = 1
cfg.MODEL.f = [60, 120, 240, 480, 960]
cfg.MODEL.D_F = [100, 200, 300, 400, 500, 600, 1200]
cfg.MODEL.RESIDUAL_BLOCK_COUNT = 9
...
cfg.SOLVER.HINGE_LOSS_THRESHOLD = 2000
cfg.SOLVER.HINGE_LOSS_FACTOR = 0.01
cfg.SOLVER.CHI = 1.05
cfg.SOLVER.CLS_LOSS_FACTOR = 1
cfg.SOLVER.REG_LOSS_FACTOR = 0.1
cfg.SOLVER.TARGET_LOSS_FACTOR = 0
cfg.SOLVER.TARGET_SENSITIVITY = 1e4
cfg.SOLVER.TARGET_CHI = 2.01
cfg.SOLVER.TARGET_CLASS = 15
cfg.SOLVER.ITERATIONS_PER_IMAGE = 100
cfg.SOLVER.DISCRIMINATOR_IMPORTANCE = 1.
cfg.SOLVER.DISC_REC_IMPORTANCE = 1.
cfg.SOLVER.DISC_LR = 0.00001
...
cfg.LOG_STEP = 1 # Print logs every log_stepPrint logs every log_step
cfg.DRAW_STEP = 20

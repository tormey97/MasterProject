...
"""
This file contains caffe2-compatible implementation of several detectron2__ components.
"""


class Caffe2Boxes(Boxes):
    """
    Representing a list of detectron2__.structures.Boxes from minibatch, each box
